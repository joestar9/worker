...
const ALIASES: Array<{ keys: string[]; code: string }> = [
  // ==========================================
  // 1. Fiat Currencies (ارزهای فیات)
  // ==========================================
  { keys: ["دلار", "usd", "تتر", "tether", "usdt", "dollar", "دلار آمریکا"], code: "usd" },
  { keys: ["یورو", "eur", "euro"], code: "eur" },
  { keys: ["پوند", "gbp", "pound", "پوند انگلیس"], code: "gbp" },
  { keys: ["درهم", "aed", "dirham", "درهم امارات"], code: "aed" },
  { keys: ["لیر", "try", "lira", "لیر ترکیه"], code: "try" },
  { keys: ["افغانی", "afn", "afghani"], code: "afn" },
  { keys: ["فرانک", "فرانک سوئیس", "chf", "swiss franc"], code: "chf" },
  { keys: ["دلار کانادا", "cad", "canadian dollar"], code: "cad" },
  { keys: ["دلار استرالیا", "aud", "australian dollar"], code: "aud" },
  { keys: ["ین", "ین ژاپن", "jpy", "japanese yen"], code: "jpy" },
  { keys: ["یوان", "یوان چین", "cny", "chinese yuan", "renminbi"], code: "cny" },
  { keys: ["کرون سوئد", "sek", "swedish krona"], code: "sek" },
  { keys: ["کرون نروژ", "nok", "norwegian krone"], code: "nok" },
  { keys: ["کرون دانمارک", "dkk", "danish krone"], code: "dkk" },
  { keys: ["روبل", "روبل روسیه", "rub", "russian ruble"], code: "rub" },
  { keys: ["ریال عربستان", "sar", "saudi riyal"], code: "sar" },
  { keys: ["دینار کویت", "kwd", "kuwaiti dinar"], code: "kwd" },
  { keys: ["دینار بحرین", "bhd", "bahraini dinar"], code: "bhd" },
  { keys: ["ریال عمان", "omr", "omani rial"], code: "omr" },
  { keys: ["ریال قطر", "qar", "qatari riyal"], code: "qar" },
  { keys: ["دینار عراق", "iqd", "iraqi dinar"], code: "iqd" },
  { keys: ["منات", "منات آذربایجان", "azn", "azerbaijani manat"], code: "azn" },
  { keys: ["درام", "درام ارمنستان", "amd", "armenian dram"], code: "amd" },
  { keys: ["روپیه", "روپیه هند", "inr", "indian rupee"], code: "inr" },
  { keys: ["رینگیت", "رینگیت مالزی", "myr", "malaysian ringgit"], code: "myr" },
  { keys: ["بات", "بات تایلند", "thb", "thai baht"], code: "thb" },
  { keys: ["دلار سنگاپور", "sgd", "singapore dollar"], code: "sgd" },
  { keys: ["دلار هنگ کنگ", "hkd", "hong kong dollar"], code: "hkd" },

  // ==========================================
  // 2. Metals & Commodities (طلا و سکه)
  // ==========================================
  { keys: ["طلا", "gold", "گرم طلا", "طلای ۱۸", "طلای18", "gram 18k"], code: "gold_gram_18k" },
  { keys: ["مثقال", "mithqal", "مثقال طلا"], code: "gold_mithqal" },
  { keys: ["سکه", "coin", "امامی", "emami", "سکه امامی"], code: "coin_emami" },

  // ==========================================
  // 3. Top Cryptocurrencies (کریپتوهای اصلی)
  // ==========================================
  { keys: ["بیت", "بیتکوین", "btc", "bitcoin", "کینگ"], code: "btc" },
  { keys: ["اتریوم", "eth", "ethereum", "اتر"], code: "eth" },
  { keys: ["بایننس کوین", "bnb", "binance coin", "بی ان بی"], code: "bnb" },
  { keys: ["ریپل", "xrp", "ripple"], code: "xrp" },
  { keys: ["سولانا", "sol", "solana", "سول"], code: "sol" },
  { keys: ["دوج", "doge", "dogecoin", "دوج کوین"], code: "doge" },
  { keys: ["کاردانو", "ada", "cardano", "آدا"], code: "ada" },
  { keys: ["ترون", "trx", "tron", "تی آر ایکس"], code: "trx" },
  { keys: ["تون", "ton", "toncoin", "تون کوین"], code: "ton" },
  { keys: ["پالیگان", "pol", "polygon", "matic", "متیک"], code: "pol" }, // Updated to POL
  { keys: ["لایت کوین", "ltc", "litecoin"], code: "ltc" },
  { keys: ["بیت کوین کش", "bch", "bitcoin cash"], code: "bch" },
  { keys: ["شیبا", "shib", "shiba", "shiba inu"], code: "shib" },
  { keys: ["آوالانچ", "avax", "avalanche", "اوالانچ"], code: "avax" },
  { keys: ["چین لینک", "link", "chainlink", "لینک"], code: "link" },
  { keys: ["یونی سواپ", "uni", "uniswap"], code: "uni" },
  { keys: ["استلار", "xlm", "stellar"], code: "xlm" },
  { keys: ["یو اس دی سی", "usdc", "usd coin"], code: "usdc" },

  // ==========================================
  // 4. Stablecoins & Others (استیبل کوین‌ها و سایر)
  // ==========================================
  { keys: ["دای", "dai"], code: "dai" },
  { keys: ["فرست دیجیتال", "fdusd", "first digital usd"], code: "fdusd" },
  { keys: ["اتنا یو اس دی", "usde", "ethena usde"], code: "usde" },
  { keys: ["پی پال یو اس دی", "pyusd", "paypal usd"], code: "pyusd" },
  { keys: ["تتر گلد", "xaut", "tether gold"], code: "xaut" },
  { keys: ["پکس گلد", "paxg", "pax gold"], code: "paxg" },

  // ==========================================
  // 5. Trendy & New Alts (آلت‌کوین‌های ترند و جدید)
  // ==========================================
  { keys: ["پپه", "pepe"], code: "pepe" },
  { keys: ["نات", "ناتکوین", "not", "notcoin"], code: "not" }, // (Added manually based on context)
  { keys: ["بونک", "bonk"], code: "bonk" },
  { keys: ["سویی", "sui"], code: "sui" },
  { keys: ["کاسپا", "kas", "kaspa"], code: "kas" },
  { keys: ["اپتوس", "apt", "aptos"], code: "apt" },
  { keys: ["آربیتروم", "arb", "arbitrum"], code: "arb" },
  { keys: ["اپتیمیزم", "op", "optimism"], code: "op" },
  { keys: ["رندر", "render", "rndr"], code: "render" },
  { keys: ["فچ ای آی", "fet", "artificial superintelligence"], code: "fet" },
  { keys: ["اینجکتیو", "inj", "injective"], code: "inj" },
  { keys: ["نیر", "near", "near protocol", "نیر پروتکل"], code: "near" },
  { keys: ["اتریوم کلاسیک", "etc", "ethereum classic"], code: "etc" },
  { keys: ["مونرو", "xmr", "monero"], code: "xmr" },
  { keys: ["اینترنت کامپیوتر", "icp", "internet computer"], code: "icp" },
  { keys: ["هدرا", "hbar", "hedera", "هدرا هشگراف"], code: "hbar" },
  { keys: ["فایل کوین", "fil", "filecoin"], code: "fil" },
  { keys: ["اتم", "atom", "cosmos", "کازماس"], code: "atom" },
  { keys: ["یمیوتبل ایکس", "imx", "immutable"], code: "imx" },
  { keys: ["استکس", "stx", "stacks"], code: "stx" },
  { keys: ["فانتوم", "ftm", "fantom"], code: "ftm" }, // Often requested, adding for safety
  { keys: ["گراف", "grt", "the graph"], code: "grt" },
  { keys: ["لیدو", "ldo", "lido dao"], code: "ldo" },
  { keys: ["ورلد کوین", "wld", "worldcoin"], code: "wld" },
  { keys: ["تائو", "tao", "bittensor", "بیت تنسور"], code: "tao" },
  { keys: ["آوه", "aave"], code: "aave" },
  { keys: ["الگوراند", "algo", "algorand"], code: "algo" },
  { keys: ["دش", "dash"], code: "dash" },
  { keys: ["تزوس", "xtz", "tezos"], code: "xtz" },
  { keys: ["کرونوس", "cro", "cronos"], code: "cro" },
  { keys: ["منتله", "mnt", "mantle", "منتل"], code: "mnt" },
  { keys: ["کوکوین", "kcs", "kucoin token"], code: "kcs" },
  { keys: ["پانکیک", "cake", "pancakeswap", "پنکیک سواپ"], code: "cake" },
  { keys: ["فلو", "flow"], code: "flow" },
  { keys: ["ئو اس", "eos"], code: "eos" },
  { keys: ["نئو", "neo"], code: "neo" },
  { keys: ["میکر", "mkr", "maker"], code: "mkr" },
  { keys: ["آیوتا", "iota"], code: "iota" },
  { keys: ["وی چین", "vet", "vechain"], code: "vet" },
  { keys: ["سندباکس", "sand", "sandbox"], code: "sand" },
  { keys: ["دیسنترالند", "mana", "decentraland", "مانا"], code: "mana" },
  { keys: ["اکسی", "axs", "axie infinity"], code: "axs" },
  { keys: ["تتا", "theta", "theta network"], code: "theta" },
  { keys: ["کوانت", "qnt", "quant"], code: "qnt" },
  { keys: ["چیلیز", "chz", "chiliz"], code: "chz" },

  // ==========================================
  // 6. Extended List (از لیست ارسالی شما)
  // ==========================================
  { keys: ["هایپرلیکویید", "hype", "hyperliquid"], code: "hype" },
  { keys: ["لئو", "leo", "unus sed leo"], code: "leo" },
  { keys: ["زدکش", "zec", "zcash"], code: "zec" },
  { keys: ["اتنا", "ena", "ethena"], code: "ena" },
  { keys: ["اسکای", "sky"], code: "sky" },
  { keys: ["ورلد لیبرتی", "wlfi", "world liberty"], code: "wlfi" },
  { keys: ["کانتون", "cc", "canton"], code: "cc" },
  { keys: ["بیت گت", "bgb", "bitget token"], code: "bgb" },
  { keys: ["اوکی بی", "okb"], code: "okb" },
  { keys: ["آستر", "aster"], code: "aster" },
  { keys: ["پای", "pi", "pi network"], code: "pi" },
  { keys: ["میدنایت", "night", "midnight"], code: "night" },
  { keys: ["میم کور", "m", "memecore"], code: "m" },
  { keys: ["گلوبال دلار", "usdg", "global dollar"], code: "usdg" },
  { keys: ["ریپل یو اس دی", "rlusd", "ripple usd"], code: "rlusd" },
  { keys: ["اندو", "ondo", "ondo finance"], code: "ondo" },
  { keys: ["ترامپ", "trump", "official trump"], code: "trump" },
  { keys: ["فلر", "flr", "flare"], code: "flr" },
  { keys: ["ایکس دی سی", "xdc", "xdc network"], code: "xdc" },
  { keys: ["میکس", "myx", "myx finance"], code: "myx" },
  { keys: ["گیت", "gt", "gatetoken"], code: "gt" },
  { keys: ["سی", "sei"], code: "sei" },
  { keys: ["پامپ", "pump", "pump.fun"], code: "pump" },
  { keys: ["آدیرا", "beat", "audiera"], code: "beat" },
  { keys: ["ژوپیتر", "jup", "jupiter"], code: "jup" },
  { keys: ["نکسو", "nexo"], code: "nexo" },
  { keys: ["پنگو", "pengu", "pudgy penguins"], code: "pengu" },
  { keys: ["کرو", "crv", "curve dao"], code: "crv" },
  { keys: ["استوری", "ip", "story protocol"], code: "ip" },
  { keys: ["ترو یو اس دی", "tusd", "trueusd"], code: "tusd" },
  { keys: ["اترفای", "ethfi", "ether.fi"], code: "ethfi" },
  { keys: ["ویرچوال", "virtual", "virtual protocol"], code: "virtual" },
  { keys: ["مرلین", "merl", "merlin chain"], code: "merl" },
  { keys: ["نیوتون", "ab", "newton"], code: "ab" },
  { keys: ["ائرودروم", "aero", "aerodrome"], code: "aero" },
  { keys: ["مورفو", "morpho"], code: "morpho" },
  { keys: ["اس پی ایکس", "spx", "spx6900"], code: "spx" },
  { keys: ["هیومن", "h", "humanity protocol"], code: "h" },
  { keys: ["استارک نت", "strk", "starknet"], code: "strk" },
];
